...
function updateCart(plant) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post("/update-cart", plant).then(function (res) {
    cartCounter.innerText = res.data.totQnty;
    toastr__WEBPACK_IMPORTED_MODULE_1___default().success("Item added to cart");
    (toastr__WEBPACK_IMPORTED_MODULE_1___default().options.timeOut) = 1;
  })["catch"](function (err) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    var plant = JSON.parse(btn.dataset.plant);
    updateCart(plant);
  });
});
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunknursery"] = self["webpackChunknursery"] || [];
